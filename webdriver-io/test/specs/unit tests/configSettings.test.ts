...
import {VercorsOptions,OptionFields} from "../../../../client/src/VerCors-CLI-UI"
import {VerCorsPaths,VercorsPath} from '../../../../client/src/VerCors-Path-UI';
...
describe('Optionmap Tests', async () => {

	it('Simple adding and removing (End To End)', async () => {
    ...
    it('Erronous and default value handling', async () => {
...
describe('PathSetting tests', async () => {
