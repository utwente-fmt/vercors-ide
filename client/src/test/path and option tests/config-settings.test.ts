...
suite('Optionmap Tests', async () => {
    ...
    test('Simple adding and removing (End To End)', async () => {
        ...
        Assert.equals(VerCorsOptions.getAllFileOptions("Design project/arr.java"), {
            pinned: [],
            flags: [],
            backend: "--backend silicon"
        }, VerCorsOptions.isEqualOptionFields)
    });
    ...
    test('Erronous and default value handling', async () => {
        ...
        let expectedOptions = {
            pinned: ["--more"],
            flags: ["--quite", "--backend-file-base"],
            backend: "--backend carbon"
        } as OptionFields
        Assert.equals(VerCorsOptions.getAllFileOptions("Design project/arrayTest.java"), expectedOptions, VerCorsOptions.isEqualOptionFields)


        fakeConfiguration["vercorsplugin.optionsMap"] = "hey"
        Assert.equals(VerCorsOptions.getAllFileOptions("Design project/arrayTest.java"), {
            pinned: [],
            flags: [],
            backend: "--backend silicon"
        }, VerCorsOptions.isEqualOptionFields)
        ...
        fakeConfiguration["vercorsplugin.optionsMap"] = {
            "Design project/arrayTest.java": { flags: ["string"] },
            pinned: "string"
        }
        Assert.equals(VerCorsOptions.getAllFileOptions("Design project/arrayTest.java"), {
            pinned: [],
        ...
        fakeConfiguration["vercorsplugin.optionsMap"] = {
            "Design project/arrayTest.java": { flags: null },
            pinned: ["string"],
            backend: "boei"
        }
        Assert.equals(VerCorsOptions.getAllFileOptions("Design project/arrayTest.java"), {
        ...
        fakeConfiguration["vercorsplugin.optionsMap"] = {
            "Design project/arrayTest.java": { flags: ["string"] },
            "Design project/arr.java": { flags: ["string"] },
            pinned: null,
            backend: null
        }
        Assert.equals(VerCorsOptions.getAllFileOptions("Design project/arr.java"), {
